...
JAVA_OPTS=-Dldfu.optimiser=OFF $ldf -p ontology/rules/data-retrieval-ldpc.n3 -p ontology/rules/ibm-semantics.n3 -p ontology/rules/spin_sparql_ask_where_query_processing.n3 -n 100 # fish-sync...
