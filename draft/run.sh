...
JAVA_OPTS=-Dldfu.optimiser=OFF $ldf -o - -p ontology/rules/data-retrieval-ldpc.n3 -p ontology/rules/ibm-semantics.n3 -p ontology/rules/spin_sparql_ask_where_query_processing.n3 -n 1500 #fish-sync...
