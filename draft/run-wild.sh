...
$ldf -p ontology/rules/data-retrieval-ldpc.n3 -p ontology/rules/ibm-semantics.n3 -p ontology/rules/list-semantics.n3 -p ontology/rules/selected_ontology_semantics.n3 -p ontology/rules/spin_sparql_ask_where_query_processing.n3 -p workflow/rules/lightCheck.n3 -o - #-n 100 # arguments
